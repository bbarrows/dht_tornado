...
dht = dhttornado.DHT(1,[], node_id = p_id)
t = dhttornado.DHTTree(dht)
dhttornado.DHTTree.MAX_LIST_LENGTH = 2
...
assert(dhttornado.dht_dist("06587bb7abe4fa1f9ef274af74cc9b17eeebf686".decode("hex"), "\x00" * 20) > dhttornado.dht_dist("01587bb7abe4fa1f9ef274af74cc9b17eeebf686".decode("hex"), "\x00" * 20))

assert(dhttornado.dht_dist("06587bb7abe4fa1f9ef274af74cc9b17eeebf686".decode("hex"), "\x00" * 20) > dhttornado.dht_dist("053099bf0ae1b4d1a30107a4f375fbbfb87beda4".decode("hex"), "\x00" * 20))
